 ...
 *--------------------------------------------------------------------------#
 * Description: IP CIDR calculator dashboard widget for pfSense.
 */
...
$tab_array = array();
$tab_array[] = array(gettext("IPv4"), $active_tab == "ipv4", "/diagnostics_cidr_calculator.php?tab=ipv4");
$tab_array[] = array(gettext("IPv6"), $active_tab == "ipv6", "/diagnostics_cidr_calculator.php?tab=ipv6");
          ...
          <select id="subnet" class="form-control">
            <?php
              ...
              foreach ($subnetMasks as $mask) {
                ...
                echo "<option value=\"{$mask}\" {$sel}>{$mask}</option>\n";
              }
            ?>
          </select>
        </td>
